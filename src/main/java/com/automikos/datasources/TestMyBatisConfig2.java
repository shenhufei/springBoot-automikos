package com.automikos.datasources;

import com.automikos.config.DBConfig2;
...
@MapperScan(basePackages = "com.automikos.test02", sqlSessionTemplateRef = "testSqlSessionTemplate2")
